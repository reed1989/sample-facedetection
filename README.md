# Face Detection\_single<a name="EN-US_TOPIC_0167573017"></a>
...
-   Downloading network model
    ...
    **Table  1**  Models used in face detection applications
    ...
    <td class="cellrowborder" valign="top" width="21.782178217821784%" headers="mcps1.2.5.1.2 "><p id="en-us_topic_0167089636_p1372429181516"><a name="en-us_topic_0167089636_p1372429181516"></a><a name="en-us_topic_0167089636_p1372429181516"></a>It is a network model converted from ResNet0-SSD300 model based on Caffe.</p>
    </td>
